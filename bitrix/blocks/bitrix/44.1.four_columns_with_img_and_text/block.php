	...
	<div class="container-fluid px-0">
		...
		<div class="row no-gutters landing-block-inner">
			<div class="landing-block-node-card col-md-6 col-lg-3">
				<!-- Article -->
				<article
						class="landing-block-node-card-inner h-100 text-center info-v3-3 g-parent g-bg-gray-light-v5 g-bg-cover g-bg-primary-opacity-0_6--after g-color-gray-dark-v3 g-color-white--hover g-py-30 g-pointer-events-before-after-none">
					<!-- Article Image -->
					...
					<div class="info-v3-3__description-sm u-link-v2 g-pointer-events-none--parent-hover g-pos-cover g-flex-middle g-white-space-normal">
						<div class="g-flex-middle-item g-pa-30 g-pointer-events-all">
