...
$MESS ['P_SET_PASSWORD'] = "Ограничить доступ к альбому по паролю";
$MESS ['P_PASSWORD'] = "Пароль";
$MESS ['P_SECTION_EDIT_ICON'] = "Изменить обложку";
$MESS ['P_SECTION_DELETE'] = "Удалить";
$MESS ['P_SECTION_DELETE_ASK'] = "Вы хотите удалить альбом со всеми вложенными альбомами без возможности восстановления?";
?>